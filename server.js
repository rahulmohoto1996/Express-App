...
const GdriveUtils = require('./routes/googleDriveUtilityFunctions');
const GauthUtils = require('./routes/googleAuthUtilityFunctions'); 
...
app.use('/tests', tests);
app.use('/users', users);
app.use('/GdriveUtils', GdriveUtils);
app.use('/GauthUtils', GauthUtils);
